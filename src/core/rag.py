...
-   **GENERAL**: 사용자의 개인 정보와 무관하며, 오직 **[검색 문서]**를 통해서만 답변할 수 있는 일반적인 질문입니다. 질문에서 구체적인 카드사명이나 정보가 언급되더라도, 그것이 **[사용자 정보]**에 포함되지 않은 경우 GENERAL로 분류합니다.
-   **HYBRID**: **[사용자 정보]**에 실제로 존재하는 정보와 **[검색 문서]**를 모두 참조해야만 정확한 답변이 가능한 질문입니다. "내 카드", "내 결제일" 등 사용자 정보와 관련된 대명사나 키워드가 포함되고, 해당 정보가 **[사용자 정보]**에 실제로 존재해야 합니다.
